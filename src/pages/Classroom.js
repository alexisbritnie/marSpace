...
export default function Classroom(){
 ...
 const[Post, setPost]=useState({user:"",title:"",description:"",link:"",class:""}); /* where i will set username and class in background */
...
const handleChange4=(event)=>{
  ...
  /*
  const addedClasses = db.collection('Credential').doc(userid)
  const res = await addedClasses.set({
  })
*/
