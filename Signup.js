        ...
        <div class="login-container">
            ...
            <form class="form">
                <div class="input-group success">
                    ...
                    <input type="email" name="email"  value= {credit.username} onChange={handleChange} placeholder="Email"></input>
                    
                </div>

                <div class="input-group error">
                    {/*<label for="password"> Password</label>*/}
                    <input type="password" name="password"  value={credit.password} onChange={handleChange} placeholder="Password"></input>
